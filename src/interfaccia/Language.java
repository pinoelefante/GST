...
//		DONAZIONI_BOTTONE_DONAZIONE = "Effettua donazione";
		...
		OPZIONI_MINUTI_RICERCA_TOOLTIP = "Clicca \"" + OPZIONI_SALVAOPZIONI + "\" per rendere l'opzione effettiva. Se il formato dei minuti Ã¨ sbagliato, default: 480 minuti";
		TRAYICON_RIPRISTINA = "Ripristina";
		TRAYICON_ESCI = "Esci";
		DIALOGUE_ERROR_UPDATE = "Impossibile verificare il software";

//		DIALOGUE_UPDATE_NUOVOAGGIORNAMENTO = "Un nuovo aggiornamento ï¿½ stato installato.\nVuoi riavviare ora il programma?";
...
//		DIALOGUE_CAMBIO_LINGUA = "Devi riavviare l'applicazione affinchï¿½ le modifiche abbiano effetto";
